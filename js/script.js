...
const apiKey = "Vwmt1lu0YIhCNT2DvyEleVeri5kjldrhyyWF8d7DLkh1EDRTe0dyxGcz";
const perPage = 15;
let currentPage = 1;
let searchTerm = null;
...
downloadImgBtn.addEventListener("click", (e) => downloadImg(e.target.dataset.img));
 ...
 var typed = new Typed('.auto-type', {
    strings: ['Hello Viewers' , 'Welcome on NeXuS' , 'Search images here','Download within a Second','Totaly-Free Platform'],
    typeSpeed: 90,
    backSpeed: 70,
    loop:true,
  })
